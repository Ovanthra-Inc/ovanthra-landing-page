...
import { Menu, X, ChevronRight, CircleCheckIcon, CircleHelpIcon, CircleIcon } from 'lucide-react'
    ...
    return (
        <>
            ...
            <main className=" mb-20">
                <section>
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-30">
                            ...
                            <div className="hidden lg:block">
                                <NavigationMenu>
                                    <NavigationMenuList>
                                        ...
                                        <NavigationMenuItem>
                                            <NavigationMenuTrigger className='cursor-pointer'>Products</NavigationMenuTrigger>
                                            <NavigationMenuContent>
